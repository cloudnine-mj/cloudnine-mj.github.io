...
* **Amazon RDS**: MySQL, PostgreSQL, Oracle, SQL Server 및 MariaDB를 위한 관리형의 곤계형 데이터베이스 서비스
...
* **Elastic Load Balacing (ELB)**: 수신 트래픽을 여러 대상에 걸쳐 분산



## :mag_right: Machine Learning

* **Amazon SageMaker**: 기계 학습 모델을 대규모로 구축, 훈련 및 배호
